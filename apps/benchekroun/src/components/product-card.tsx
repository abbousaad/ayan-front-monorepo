  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex flex-1 flex-col gap-2">
        <h2 className="font-display text-lg font-semibold leading-6 text-brand-ink">{product.name}</h2>
        {product.description && (
          <p className="line-clamp-2 text-xs leading-5 text-brand-muted">{product.description}</p>
        )}
